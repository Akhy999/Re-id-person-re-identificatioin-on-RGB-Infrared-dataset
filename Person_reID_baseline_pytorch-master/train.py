...
parser.add_argument('--data_dir',default='../input/testdata/pytorch',type=str, help='training dir path')
...
def draw_curve(current_epoch):
    ...
    if current_epoch == 0:
        ax0.legend()
        ax1.legend()
    fig.savefig( os.path.join(name,'train.jpg'))
...
def save_network(network, epoch_label):
    ...
    save_path = os.path.join(name,save_filename)
